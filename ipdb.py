...
DEVICE_PLATFORM = {
    DimmableLightingControl: {LIGHT: [1]},
    DimmableLightingControl_DinRail: {LIGHT: [1]},
    DimmableLightingControl_FanLinc: {LIGHT: [1], FAN: [2]},
    DimmableLightingControl_InLineLinc: {LIGHT: [1]},
    DimmableLightingControl_KeypadLinc_6: {LIGHT: [1], SWITCH: range(2, 7)},
    DimmableLightingControl_KeypadLinc_8: {LIGHT: [1], SWITCH: range(2, 9)},
    DimmableLightingControl_LampLinc: {LIGHT: [1]},
    DimmableLightingControl_OutletLinc: {LIGHT: [1]},
    DimmableLightingControl_SwitchLinc: {LIGHT: [1]},
    DimmableLightingControl_ToggleLinc: {LIGHT: [1]},
    ...
    SecurityHealthSafety_DoorSensor: {BINARY_SENSOR: [1, 3, 4]},
    SecurityHealthSafety_LeakSensor: {BINARY_SENSOR: [2, 4]},
    SecurityHealthSafety_MotionSensor: {BINARY_SENSOR: [1, 2, 3, 4]},
    SecurityHealthSafety_OpenCloseSensor: {BINARY_SENSOR: [1]},
    SecurityHealthSafety_Smokebridge: {BINARY_SENSOR: [1]},
    SensorsActuators_IOLink: {SWITCH: [1], BINARY_SENSOR: [2]},
    SwitchedLightingControl: {SWITCH: [1]},
    SwitchedLightingControl_ApplianceLinc: {SWITCH: [1]},
    SwitchedLightingControl_DinRail: {SWITCH: [1]},
    SwitchedLightingControl_InLineLinc: {SWITCH: [1]},
    SwitchedLightingControl_KeypadLinc_6: {SWITCH: range(1, 7)},
    SwitchedLightingControl_KeypadLinc_8: {SWITCH: range(1, 9)},
    SwitchedLightingControl_OnOffOutlet: {SWITCH: [1, 2]},
    SwitchedLightingControl_OutletLinc: {SWITCH: [1]},
    SwitchedLightingControl_SwitchLinc: {SWITCH: [1]},
    SwitchedLightingControl_ToggleLinc: {SWITCH: [1]},
